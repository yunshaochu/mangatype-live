                         ...
                         {isSelectedMaskErase ? (
                             ...
                             <div className="space-y-3 animate-fade-in">
                                 ...
                                 <div className="bg-gray-800/30 p-3 rounded-xl border border-gray-800 space-y-3">
                                     ...
                                     {/* Precise fill quick-toggles */}
                                     <div className="space-y-1.5 pt-1 border-t border-gray-700/50">
                                         {/* Parent: usePreciseFill */}
                                         <div className="flex items-center justify-between">
                                             <span className="text-[10px] text-gray-300">{t('preciseFill', lang)}</span>
                                             <label className="relative inline-flex items-center cursor-pointer">
                                                 <input type="checkbox" className="sr-only peer"
                                                     checked={aiConfig.usePreciseFill || false}
                                                     onChange={(e) => setAiConfig({...aiConfig, usePreciseFill: e.target.checked})}
                                                 />
                                         ...
                                         {/* Children: only visible when precise fill is enabled */}
                                         {aiConfig.usePreciseFill && (
                                             <>
                                                 <div className="flex items-center justify-between pl-2 border-l-2 border-orange-500/30">
