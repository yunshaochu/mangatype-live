...
export const translations = {
  zh: {
    ...
    detectApiVersionHint: "V1: ComicTextDetector (含轮廓mask)；V2: RT-DETR-v2 (支持气泡/文本分类)。",
  ...
  en: {
    ...
    detectApiVersionHint: "V1: ComicTextDetector (with contour mask); V2: RT-DETR-v2 (bubble/text classification).",
