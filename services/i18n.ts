...
export const translations = {
  zh: {
    ...
    extraLayoutVariantCount: "额外候选数",
    extraLayoutVariantCountHint: "该数值不包含第 0 组主结果。V1 仅请求额外候选，不做自动测量或自动优选。",
    maskGeometry: "遮罩形状",
    width: "宽",
    height: "高",
    whiteBg: "白底遮罩",
  ...
  en: {
    ...
    extraLayoutVariantCount: "Extra Variants",
    extraLayoutVariantCountHint: "This count does not include the group-0 main result. V1 only requests extra candidates and does not auto-measure or auto-pick a winner.",
