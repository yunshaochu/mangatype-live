...
export const translations = {
  zh: {
    ...
    deleteBubble: "删除气泡",
    sourceText: "原文",
    enterSourceText: "输入原文...",
    content: "内容",
    enterText: "输入文本...",
    layoutVariant: "候选",
    layoutVariantMain: "主结果",
    layoutVariantCount: "额外候选",
    previousLayoutVariant: "上一组候选",
    nextLayoutVariant: "下一组候选",
    maskGeometry: "遮罩形状",
    width: "宽",
    height: "高",
    whiteBg: "白底遮罩",
    ...
    imagePanelTitle: "当前图片",
    imagePanelHint: "未选中气泡或遮罩时，这里显示当前图片摘要与 AI JSON 入口。",
    imagePanelIdle: "待处理",
    imagePanelBubbleCount: "气泡数",
    imagePanelMaskCount: "遮罩数",
    imagePanelLatestSource: "最近结果",
    imagePanelNoDebug: "暂无成功快照",
    imagePanelJsonReady: "已缓存",
    imagePanelJsonEmpty: "暂无 JSON",
    imagePanelProvider: "Provider",
    imagePanelUpdatedAt: "更新时间",
    imagePanelViewJson: "查看 AI JSON",
    imagePanelViewJsonHint: "查看当前图片最近一次成功应用的结构化结果。",
    imagePanelNoDebugHint: "需要先完成一次自动翻译或手动导入。",
    aiJsonModalTitle: "AI JSON 查看",
    aiJsonModalCopy: "复制 JSON",
    aiJsonModalCopied: "已复制",
    aiJsonModalSource: "来源",
    aiJsonModalProvider: "Provider",
    aiJsonModalModel: "模型",
    aiJsonModalBubbleCount: "气泡数",
    aiJsonModalCapturedAt: "采集时间",
    aiSettings: "AI 设置",
    aiProvider: "AI 提供商",
    baseUrl: "Base URL",
    apiKey: "API Key",
    ...
    preciseFill: "精确轮廓填充",
    preciseFillHint: "填充红框时，仅涂抹文字轮廓像素，而非整块矩形。需先扫描获取轮廓数据。",
    showContourPreview: "显示轮廓预览",
    showContourPreviewHint: "以橙色叠加显示识别到的文字轮廓，供参考。",
    useCharRects: "单字矩形模式",
    useCharRectsHint: "开启时，填充每个文字的独立矩形边界；关闭时，使用轮廓粗填充（稍粗一圈的文字形状）。",
    preInpaintContour: "预填充轮廓再擦除",
    preInpaintContourHint: "使用 API 擦除前，先将文字轮廓以白色覆盖，帮助 AI 更彻底地去除文字笔迹。",
    ...
    exportMethod: "导出方式",
    exportMethodHint: "「Canvas」使用传统画布渲染（默认）。「截图」使用 CSS 截图，所见即所得，与编辑器显示完全一致。",
    exportMethodCanvas: "Canvas 渲染",
    exportMethodScreenshot: "截图模式 (WYSIWYG)",
    exportSkippedAsOriginal: "跳过图片始终导出原图",
    exportSkippedAsOriginalHint: "这是固定行为：被标记为跳过的图片在下载、ZIP 和合并图层时始终保留原图，用于保持 skip 语义一致。",
    ...
    cornerRadius: "圆角半径",
    feathering: "羽化程度",
    textStyleDefaults: "文字样式默认值",
    textStyleDefaultsDesc: "设置新建气泡的默认文字样式。",
    defaultFont: "默认字体",
    defaultDirection: "默认排版方向",
    defaultLetterSpacing: "默认字间距",
    defaultLineHeight: "默认行高",
    defaultTextColor: "默认文字颜色",
    defaultStrokeColor: "默认描边颜色",
    defaultBgColor: "默认背景颜色",
    resetStyleDefaults: "重置样式默认值",
    resetStyleDefaultsConfirm: "确定要重置所有样式默认值吗？",
    resetStatus: "重置状态",
    // Model Capabilities
    ...
    scanCurrent: "扫描当前文字",
    scanAll: "扫描全部文字",
    detectGuideMode: "断连线模式",
    clearDetectGuides: "清空断连线",
    detectGuideHint: "先画断连线，再重扫当前页。",
    detectGuideActive: "断连线模式已开启：拖动画线，Esc 退出。",
  ...
  en: {
    ...
    layoutVariantMain: "Main",
    layoutVariantCount: "Extra",
    previousLayoutVariant: "Previous Variant",
    nextLayoutVariant: "Next Variant",
    ...
    imagePanelTitle: "Current Image",
    imagePanelHint: "When no bubble or mask is selected, this panel shows the image summary and AI JSON entry.",
    imagePanelIdle: "Idle",
    imagePanelBubbleCount: "Bubbles",
    imagePanelMaskCount: "Masks",
    imagePanelLatestSource: "Latest Result",
    imagePanelNoDebug: "No successful snapshot yet",
    imagePanelJsonReady: "Snapshot Ready",
    imagePanelJsonEmpty: "No JSON Yet",
    imagePanelProvider: "Provider",
    imagePanelUpdatedAt: "Updated",
    imagePanelViewJson: "View AI JSON",
    imagePanelViewJsonHint: "Inspect the latest successful structured result for this image.",
    imagePanelNoDebugHint: "Run translation or import JSON once to unlock this.",
    aiJsonModalTitle: "AI JSON Viewer",
    aiJsonModalCopy: "Copy JSON",
    aiJsonModalCopied: "Copied",
    aiJsonModalSource: "Source",
    aiJsonModalProvider: "Provider",
    aiJsonModalModel: "Model",
    aiJsonModalBubbleCount: "Bubbles",
    aiJsonModalCapturedAt: "Captured At",
    ...
    preciseFill: "Precise Contour Fill",
    preciseFillHint: "When filling red boxes, paint only text contour pixels instead of the whole rectangle. Requires a prior scan to retrieve contour data.",
    showContourPreview: "Show Contour Preview",
    showContourPreviewHint: "Overlay detected text contours in orange as a visual reference.",
    useCharRects: "Per-Character Rect Mode",
    useCharRectsHint: "When on, fills each character's individual bounding rect. When off, uses a thickened contour fill (text shape, slightly dilated).",
    preInpaintContour: "Pre-fill Contour Before Erasing",
    preInpaintContourHint: "Before calling the inpaint API, overlay the text contour in white to help the AI remove stroke pixels more completely.",
    ...
    exportMethodHint: "'Canvas' uses traditional canvas rendering (default). 'Screenshot' captures CSS rendering for pixel-perfect WYSIWYG output matching the editor.",
    exportMethodCanvas: "Canvas Rendering",
    exportMethodScreenshot: "Screenshot (WYSIWYG)",
    exportSkippedAsOriginal: "Skipped Images Keep Original",
    exportSkippedAsOriginalHint: "This behavior is always on. Skipped images keep the untouched original in download, ZIP, and merge flows so skip semantics stay consistent.",
    ...
    unskipSelected: "Unskip Selected",
    exportSelected: "Export Selected",
    cancelSelection: "Cancel Selection",
    resetStatusSelected: "Reset Status",
    ...
    textStyleDefaults: "Text Style Defaults",
    textStyleDefaultsDesc: "Set default text style for new bubbles.",
    defaultFont: "Default Font",
    defaultDirection: "Default Direction",
    defaultLetterSpacing: "Default Letter Spacing",
    ...
    resetStyleDefaults: "Reset Style Defaults",
    resetStyleDefaultsConfirm: "Reset all style defaults to factory values?",
    ...
    detectGuideMode: "Separator Mode",
    clearDetectGuides: "Clear Separators",
    detectGuideHint: "Draw separator lines, then rescan the current page.",
    detectGuideActive: "Separator mode active: drag to draw, Esc to exit.",
