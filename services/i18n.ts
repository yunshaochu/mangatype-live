...
export const translations = {
  zh: {
    ...
    detectApiVersion: "检测 API 版本",
    detectApiVersionHint: "V1: ComicTextDetector (含轮廓mask)；V2: RT-DETR-v2 (支持气泡/文本分类，可选文字轮廓)。",
    v2DetectTextContour: "V2 文字轮廓检测",
    v2DetectTextContourHint: "V2 检测时同时获取像素级文字轮廓 mask。会增加检测耗时（首次加载轮廓模型约需 30-60 秒）。",
  ...
  en: {
    ...
    detectApiVersion: "Detection API Version",
    detectApiVersionHint: "V1: ComicTextDetector (with contour mask); V2: RT-DETR-v2 (bubble/text classification, optional text contours).",
    v2DetectTextContour: "V2 Text Contour Detection",
    v2DetectTextContourHint: "Fetch pixel-level text contour masks together with V2 detections. Slower — first request loads the contour model (~30-60s).",
