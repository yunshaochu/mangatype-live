...
export const translations = {
  zh: {
    ...
    screenshotPunctuationOffset: "竖排标点偏移修正",
    screenshotPunctuationOffsetHint: "修正截图导出中竖排标点位置偏移，仅影响截图导出模式。",
    editorPunctuationOffset: "编辑器标点偏移修正",
    editorPunctuationOffsetHint: "修正编辑器中竖排标点位置偏移，仅影响编辑器显示。",
    punctuationTab: "标点修正",
    punctuationTabHint: "调整竖排文字中标点符号的水平偏移量，分别针对编辑器和截图导出。",
    punctuationChar: "字符",
    punctuationOffset: "偏移 (em)",
    punctuationOffsetY: "垂直偏移",
    punctuationRotate: "旋转角度",
    punctuationScale: "缩放",
    addPunctuation: "添加",
  ...
  en: {
    ...
    screenshotPunctuationOffset: "Screenshot Punctuation Offset",
    screenshotPunctuationOffsetHint: "Fix vertical punctuation position offset in screenshot export. Only affects screenshot mode.",
    editorPunctuationOffset: "Editor Punctuation Offset",
    editorPunctuationOffsetHint: "Fix vertical punctuation position offset in editor display. Only affects editor view.",
    punctuationTab: "Punctuation",
    punctuationTabHint: "Adjust horizontal offset of punctuation in vertical text, separately for editor and screenshot export.",
    punctuationChar: "Char",
    punctuationOffset: "Offset (em)",
    punctuationOffsetY: "Y Offset",
    punctuationRotate: "Rotate",
    punctuationScale: "Scale",
    addPunctuation: "Add",
